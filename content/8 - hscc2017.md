...
1. **Not an Eulerian method (not a grid based method)**: This implies that we
...
# Nice job!!! Where do I get more details?

You can find the paper on [Arxiv](https://arxiv.org/abs/1610.04550). You can
find the MATLAB code for generating these figures on my [webpage]().

[^systems]: This class of systems include affine noise perturbed LTI
